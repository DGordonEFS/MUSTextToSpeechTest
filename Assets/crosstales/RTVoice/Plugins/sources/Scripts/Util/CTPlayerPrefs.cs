...
namespace Crosstales.RTVoice.Util
{
    ...
    public static class CTPlayerPrefs
    {
        ...
        /// Exists the key?
        /// </summary>
        /// <param key="key">Key for the PlayerPrefs.</param>
        ...
        /// Delete the key.
        /// </summary>
        /// <param key="key">Key to delete in the PlayerPrefs.</param>
        ...
        public static bool GetBool(string key)
        {
            ...
            return string.Equals(PlayerPrefs.GetString(key), "true", StringComparison.OrdinalIgnoreCase) ? true : false;
        }
        ...
        /// </summary>
        /// <param key="key">Key for the PlayerPrefs.</param>
        /// <param key="value">Value for the PlayerPrefs.</param>
